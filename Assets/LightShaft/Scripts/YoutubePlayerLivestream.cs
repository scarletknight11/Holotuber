//using monoflow;   //FOR MPMP uncomment this
using RenderHeads.Media.AVProVideo;   //FOR AVPRO UNCOMMENT THIS
...
public class YoutubePlayerLivestream : MonoBehaviour {
    ...
    void OnLiveUrlLoaded(string url)
    {
        ...
        //AVPRO Part
        //uncomment the avpro include in the beggining of the script
        ...
        //MPMP
        //uncomment the MPMP includes in the beggining of the script.
