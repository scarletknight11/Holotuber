You need to have the HLS playback plugin in project to see how to use open the script YoutubePlayerLivestream.cs and go to the function:
OnLiveUrlLoaded() you will see instructions, you can uncomment lines if the player that you are using is in there.
